let pokemonRepository = (function () {
  ...
  /*Function that takes in a pokemon as a paramater and loads the pokemon details
  and send them to the showModal function.*/
  ...
  function showDialog() {
    ...
    let confirmButton = $(
      '<button class="btn btn-primary button-class">Confirm</button>'
    );
  ...
  function pokeTest(var1) {
    return pokemonList.filter(
      (nameCheck) => nameCheck.name.toLowerCase() === var1.toLowerCase()
    );
  }
